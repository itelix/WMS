...
public class RouteChooseTest_9 extends  RouteChooseAbs{

	public RouteChooseTest_9(long seed) {
		super(seed);
	}

	public RouteChooseTest_9() {
		super();
	}
	@Override
	...
	public List<BaseRequest> getBaseRequest() {
		...
		productList3.add( new LocPriority( createPos(0, 21), 0.99) ); 
		
		//destination
		BaseRequest br3 = new BaseRequest( 3, mvc1, productList3 );
	...
	public static void main(String[] args) {
		RouteChooseTest_9 t = new RouteChooseTest_9(123l);
