...
public class RouteChooseTest_5 extends  RouteChooseAbs{

	public RouteChooseTest_5(long seed) {
		super(seed);
	}
	
	public RouteChooseTest_5() {
		super();
	}
...
//		Random rnd = new Random(rndSeed.nextInt(154));
	...
	public static void main(String[] args) {
		RouteChooseTest_5 t = new RouteChooseTest_5(123);
