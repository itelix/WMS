...
public class RouteChooseTest_ManyTasks extends RouteChooseAbs {
	private static final int TASKS_NUM = 10;
	Random rnd = new Random();
	
	public RouteChooseTest_ManyTasks(long seed) {
		super(seed);
	}
	
	public RouteChooseTest_ManyTasks() {
		super();
	}
...
//			loc.add(createPos(29*rnd.nextInt(1), 10 + rnd.nextInt(20)));
			loc.add(createPos(xx[rnd.nextInt(4)], 10 + rnd.nextInt(10)));
	...
	public static void main(String[] args) {
		RouteChooseTest_ManyTasks t = new RouteChooseTest_ManyTasks(123);
