...
public class RouteChooseTest_3 extends  RouteChooseAbs{

	public RouteChooseTest_3(long seed) {
		super( seed);
	}
	
	public RouteChooseTest_3() {
		super();
	}
	...
	public List<BaseRequest> getBaseRequest() {
		...
		productList2.add( new LocPriority( createPos(0,25), 0.99) ); 
		//productList1.add( new LocPriority( createPos(0,11), 0.98) ); 
		//productList1.add( new LocPriority( createPos(0,12), 0.90) ); 
	...
	public static void main(String[] args) {
		RouteChooseTest_3 t = new RouteChooseTest_3(123);
		t.runTest();
