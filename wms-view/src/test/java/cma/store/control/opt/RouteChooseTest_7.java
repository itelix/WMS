...
public class RouteChooseTest_7 extends  RouteChooseAbs{

	public RouteChooseTest_7(long seed) {
		super(seed);
	}

	public RouteChooseTest_7() {
		super();
	}
	@Override
	...
	public static void main(String[] args) {
		RouteChooseTest_7 t = new RouteChooseTest_7(123);
