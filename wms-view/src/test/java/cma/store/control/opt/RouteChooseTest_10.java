...
public class RouteChooseTest_10 extends RouteChooseAbs{

	public RouteChooseTest_10(long seed) {
		super(seed);
	}
	
	public RouteChooseTest_10() {
		super();
	}
...
//		bots.add( createBot( 8,8) );
	...
	public static void main(String[] args) {
		...
		RouteChooseTest_10 t = new RouteChooseTest_10(123);
